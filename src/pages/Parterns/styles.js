...
export const PartnerListHeader = styled.div`
    display: grid;
...
export const PartnerListHeaderLabel = styled.h5`
    font-size: 14px;
`;
...
export const PartnerValueContainer = styled.div`
    display: flex;
    align-items: center;
    flex-direction: row;
`;

export const PartnerValue = styled.a`
    font-size: 15px;
    font-weight: bold;
    color: ${colors.mainText};
